...
function [risk_factors, gradient, hessian, spot_rates, AE] = get_PCA_data(c, tau,forward_rates)
...
A_spot_rates = create_A(size(forward_rates,1)); 
spot_rates = transpose(A_spot_rates)*forward_rates;
